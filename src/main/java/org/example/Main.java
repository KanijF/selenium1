...
public class Main {
    public static void main(String[] args) throws InterruptedException {
       ...
       //Initiate selenium WebDriver
        ...
        // Logout
        //Explicit wait
        //wait for hamburger menu to be clickable until 5000 milliseconds
        //It will keep checking every 500 milliseconds to the  clickability until the timeout of 5000 milliseconds
